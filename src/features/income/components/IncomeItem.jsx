...
const IncomeItem = ({ ingreso, onDeleteIncome, onEditIncome }) => {
  const { id, fecha, categoria, descripcion, monto } = ingreso
  const categoriaLabel = CATEGORIAS_INGRESOS.find(cat => cat.value === categoria)?.label || categoria;
